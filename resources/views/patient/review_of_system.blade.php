        ...
        $(document).ready(function(){
            ...
            function unloadPage(){
                if((inputsChanged_ros_constitutional_form || inputsChanged_ros_hent_form || inputsChanged_ros_eyes_form || inputsChanged_ros_respiratory_form
                    || inputsChanged_ros_cardiovascular_form || inputsChanged_ros_musculoskeletal_form || inputsChanged_ros_integumentary_form || inputsChanged_ros_neurological_form || inputsChanged_ros_psychological_form) && inputsChangedddx) {
                    return "Do you want to leave this page?. Changes you made to ROS and DDX may not be saved.";
                }else if(inputsChanged_ros_constitutional_form || inputsChanged_ros_hent_form || inputsChanged_ros_eyes_form || inputsChanged_ros_respiratory_form
                    ...
                    return "Do you want to leave this page?. Changes you made to ROS may not be saved.";
                }else if(inputsChangedddx){
                    return "Do you want to leave this page?. Changes you made to DDX may not be saved.";
                }
