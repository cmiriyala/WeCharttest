...
<div class="content">
    ...
    <div class="form-group">
        <div class="row ">
            <div class="col-md-5  pull-right">
                <button id="mybutton" class="btn btn-primary" ><span class="glyphicon glyphicon-off"></span> Clear All</button>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-sm-3"><a id="closeaudio" ><span class="glyphicon glyphicon-remove" style="color:#ad122a"></span></a></div>
        </div>
        <br>
        <div class="row">
            <div class="col-sm-1"></div>
    ...
    <div class="form-group">
        ...
        <div class="row">
            ...
            <div class="col-sm-3"><a id="closevideo" ><span class="glyphicon glyphicon-remove" style="color:#ad122a"></span></a></div>
    ...
    <div class="form-group">
        ...
        <div class="row">
            ...
            <div class="col-sm-3"><a id="closepictures" ><span class="glyphicon glyphicon-remove" style="color:#ad122a"></span></a></div>
        </div>
        <br>
        <div class="row">
            <div class="col-sm-1"></div>
