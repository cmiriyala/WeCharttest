...
<div class="container-fluid">
        ...
        <table class="table table-striped table-bordered table-hover" id="vital_signs_table">
            ...
            <tr>
                <th style="background: linear-gradient(#af9999,#b3b8bf)" colspan="12">
                    <a data-toggle="collapse" href="#vital_signs" class="text-secondary">Vital Signs</a>
                </th>
            </tr>
            <tr class="bg-warning">
                <th>Timestamp</th>
    ...
    <div class="row">
        <div class="panel panel-default">
            <div class="panel-heading" style="background: linear-gradient(#af9999,#b3b8bf);padding-bottom: 0">
                <a data-toggle="collapse" href="#mdm" class="text-secondary">MDM/Plan</a>
            </div>
                    ...
                    @foreach ($diagnosis_list_ddx as $diagnosis)
                        <tr id="<?php echo $diagnosis->active_record_id; ?>">
                            ...
                            @if($diagnosis->comments==null)
                                <td><textarea type="text" id="Textcom" name="Textcom[]" data-diagnosisid="{{$diagnosis->active_record_id}}" disabled></textarea></td>
                            @else
                                <td><textarea type="text" id="Textcom" name="Textcom[]" data-diagnosisid="{{$diagnosis->active_record_id}}" disabled>{{$diagnosis->comments}}</textarea></td>
                            @endif
                        </tr>
                    @endforeach
                    </tbody>
