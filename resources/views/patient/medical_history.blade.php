...
@section('documentation_panel')
    ...
    <script>
         ...
         $(document).ready(function()
         {
             ...
             function unloadPage(){
                 if(inputsChanged_personal_history_form || inputsChanged_family_history_form || inputsChanged_social_history_form || inputsChanged_surgical_history_form|| inputsChangedddx){
