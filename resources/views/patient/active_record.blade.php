            ...
            <div class="col-md-4" style="float: right;border: thin solid grey; height: auto; padding: 0; border-radius: 5px;" id="guidance_panel">
                ...
                <div class="container-fluid" id="tabdiv">
                    <ul class="nav nav-pills" id="myTab">
                        ...
                        <li id="testddxlink"><a data-toggle="pill" href="#ddx">DDx</a></li>
                        <li><a data-toggle="pill" href="#av">A/V</a></li>
                    </ul>

                    <div class="tab-content">
                        <div id="main" class="tab-pane fade tab-pane fade in active">
              ...
              {{--  <?php session()->put('ddxid', 'ddx');
                session()->put('ddxlink', 'testddxlink');
                ?>--}}
                <!-- Guidance Panel -->
