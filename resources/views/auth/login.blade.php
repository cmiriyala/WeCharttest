...
<div class="loginBox">
    ...
    <div class="form-group">
        ...
        @else
            <div class="col-md-1 col-md-offset-5" style="margin-left:43vw;margin-top:145vh;position: absolute">
            ...
            <div class="col-md-1 col-md-offset-5" style="margin-left:118vw;margin-top:145vh;position: absolute">
