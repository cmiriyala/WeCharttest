...
<div class="loginBox">
    ...
    <div class="form-group">
        @if ($errors->has('email'))
            <div class="col-md-1 col-md-offset-5" style="margin-left:5%;margin-top:34vh;position: fixed">
                <a href="#login-box" class="login-window">About WeChart</a><br>
            </div>
            <div class="col-md-1 col-md-offset-5" style="margin-left:18.5%;margin-top:34vh;position: fixed">
                <a href="#">Contact us</a>
            </div>
        <script>
            setTimeout(function() {
        ...
        @else
            <div class="col-md-1 col-md-offset-5" style="margin-left:6vw;margin-top:36vh;position: absolute">
            ...
            <div class="col-md-1 col-md-offset-5" style="margin-left:17vw;margin-top:36vh;position: absolute">
