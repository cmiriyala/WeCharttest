...
<div class="loginBox">
    ...
    <div class="form-group">
        ...
        @else
            <div class="col-md-1 col-md-offset-5" style="margin-left:6vw;margin-top:35vh;position: absolute">
            ...
            <div class="col-md-1 col-md-offset-5" style="margin-left:17vw;margin-top:35vh;position: absolute">
