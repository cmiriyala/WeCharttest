...
<div class="loginBox">
    ...
    <div class="form-group">
        ...
        @else
            <div class="col-md-1 col-md-offset-5" style="margin-left:43%;margin-top:145%;position: absolute">
            ...
            <div class="col-md-1 col-md-offset-5" style="margin-left:118%;margin-top:145%;position: absolute">
