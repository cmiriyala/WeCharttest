...
<div class="loginBox">
    ...
    <div class="form-group">
        ...
        @else
            <div class="col-md-1 col-md-offset-5" style="margin-left:1vw;margin-top:1vh;position: absolute">
            ...
            <div class="col-md-1 col-md-offset-5" style="margin-left:10vw;margin-top:10vh;position: absolute">
