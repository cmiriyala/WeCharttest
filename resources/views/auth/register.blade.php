                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group{{ $errors->has('departmentName') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <select id="departmentName" class="form-control" name="departmentName" value="{{ old('departmentName') }}" onchange='Checkfunc(this.value);' >
                                        <option value=""> </option>
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" name="security_question1_Id" value="{{ old('security_question1_Id') }}">
                                        @foreach ($securityquestions as $question)
                                            <option value="{{ $question->security_question_id }}">
