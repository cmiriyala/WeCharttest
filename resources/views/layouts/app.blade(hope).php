...
<body>
    ...
    <div>
    <img src="{{ URL::asset('logos/footer.png') }}" alt="Footer" style="height:250px;width:100%;">
        <img src="{{ URL::asset('logos/unmc.PNG') }}" alt="UNMC logo" style="height: 65px;width: 90px;margin-left: 45%;margin-top: -6%">
    </div>
