...
<body>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    ...
                                    @foreach(auth()->user()->readNotifications as $notification)
                                        <li>
                                            <a href="">@include('layouts.partials.notification.'.snake_case(class_basename($notification->type)))</a>
                                        </li>
                                    @endforeach
                                </ul>
                            </li>
    ...
    <div class="form-group footr" style="border: 0px;padding-bottom: 0px; box-shadow: inset 0 -23px 0 #AC1F2D;margin-bottom: 0%">
        <img src="/logos/footer.png" alt="Footer" style="height:180px;width:100%;margin-top: 0%;margin-bottom: 0%">
        ...
        <div class="col-md-3 col-md-offset-5" style="margin-top: -3.3%;margin-left: 54.5%;margin-bottom: 0%">
